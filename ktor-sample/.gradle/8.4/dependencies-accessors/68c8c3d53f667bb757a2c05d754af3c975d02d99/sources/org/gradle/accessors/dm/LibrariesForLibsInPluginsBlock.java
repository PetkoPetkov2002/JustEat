...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class KtorServerLibraryAccessors extends SubDependencyFactory {
        ...
        private final KtorServerRequestLibraryAccessors laccForKtorServerRequestLibraryAccessors = new KtorServerRequestLibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at ktor.server.request
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public KtorServerRequestLibraryAccessors getRequest() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForKtorServerRequestLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class KtorServerRequestLibraryAccessors extends SubDependencyFactory {

        public KtorServerRequestLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for validation (io.ktor:ktor-server-request-validation)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("ktor.server.request.validation");
        }
